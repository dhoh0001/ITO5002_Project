...
const Modal = (props) => {
  ...
  const formSubmit = (event) => {
    ...
    const url = `http://ec2-13-239-65-84.ap-southeast-2.compute.amazonaws.com/data?userId=${props.userId}&logId=${formObject.logId}&timestamp=${formObject.timestamp}&value=${formObject.value}`
  ...
  return (
    <>
        ...
        <span className="flex-1 ml-3 whitespace-nowrap">Add Log Data</span>
    </a>
        ...
        <div>
            <form className="" action="#" method="POST" onSubmit={formSubmit}>
                <div className="border-2 border-gray-200 border-dashed rounded-lg text-white mx-2">
                    ...
                    <label className="block text-sm font-bold mx-2 text-white pt-4">Timestamp</label>
                    <input id="timestamp" name="timestamp"  className="shadow mx-2 justify-center appearance-none border rounded py-2 px-1 text-black" />
                    <label className="block text-sm font-bold mx-2 text-white pt-4">Value (To One Decimal Point)</label>
                    <input id="value" name="value"  className="shadow mx-2 justify-center appearance-none border rounded py-2 px-1 text-black" />
                    <div className="pt-4">
