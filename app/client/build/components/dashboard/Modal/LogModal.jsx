...
const Modal = (props) => {
  ...
  return (
    <>
        <a className="flex items-center p-2 text-gray-900 rounded-lg dark:text-white hover:bg-gray-100 dark:hover:bg-gray-700" onClick={() => setShowLogDataModal(true)}>
        ...
        <div>
            <form className="" action="#" method="POST" onSubmit={formSubmit}>
                <div className="border-2 border-gray-200 border-dashed rounded-lg text-white mx-2">
                    <label className="block text-sm font-bold mx-2 text-white pt-4">Log ID <span className="text-red-500" onClick={() => setShowLogDataModal(false)}>X</span></label>
