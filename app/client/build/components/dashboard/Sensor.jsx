        ...
        <>
            ...
            {showSensorModal ? (
                <div className="absolute z-50 m-auto left-0 right-0 secondary-colour w-3/12 h-fit p-4"> 
                    <div>
                        <label className="block text-sm font-bold mx-2 text-white pt-4 pb-4">Edit Sensors <span className="text-red-500" onClick={() => setShowSensorModal(false)}>X</span></label>
