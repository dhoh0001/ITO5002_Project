    ...
    const formSubmit = (event) => {
        ...
        createUserWithEmailAndPassword(auth, formObject.email, formObject.password, formObject.firstName, formObject.lastName)
            .then((userCredential) => {
                ...
                const url = `http://ec2-3-27-73-173.ap-southeast-2.compute.amazonaws.com`
                const url2 = `http://ec2-3-27-73-173.ap-southeast-2.compute.amazonaws.com/user?uid=${user.uid}&firstName=${formObject.firstName}&lastName=${formObject.lastName}&email=${user.email}`
