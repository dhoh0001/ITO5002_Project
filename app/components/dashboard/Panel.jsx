...
const Panel = () => {
    ...
    const formSubmit = (event) => {
        ...
        const url = `http://ec2-13-239-65-84.ap-southeast-2.compute.amazonaws.com/log?userId=1&logId=${formObject.logId}&name=${formObject.logName}&sensorId=${formObject.sensorId}&farmId=${formObject.farmId}&logSetting=${formObject.logSetting}`
    ...
    //       const getUrl = `http://ec2-13-239-65-84.ap-southeast-2.compute.amazonaws.com/log`;
    //       const params = {
    //         params: {
    //           farmId: 1,
    //           userId: 1,
    ...
    //       const url = `http://ec2-13-239-65-84.ap-southeast-2.compute.amazonaws.com/log?logId=1`
