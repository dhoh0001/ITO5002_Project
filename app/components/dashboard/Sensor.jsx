...
const Sensor = (props) => {
    ...
    const formSubmit = (event) => {
        ...
        const url = `http://ec2-3-27-73-173.ap-southeast-2.compute.amazonaws.com/sensor?userId=${props.userId}&sensorId=1&name=${formObject.sensorName}&hardwareId=${formObject.sensorId}&sensorAction=${formObject.sensorAction}`
    ...
    const deleteSensor = (event) => {
        if (user?.accessToken) {
          ...
          const url = `http://ec2-3-27-73-173.ap-southeast-2.compute.amazonaws.com/sensor?sensorId=1`
