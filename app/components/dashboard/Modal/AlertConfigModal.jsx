...
const Modal = () => {
  ...
  const formSubmit = (event) => {
    ...
    const url = `http://ec2-3-27-73-173.ap-southeast-2.compute.amazonaws.com/alert?userId=1&alertId=${formObject.alertId}&name=${formObject.alertName}&alertLevel=${formObject.alertLevel}&timeframe=${formObject.alertTimeframe}&farmId=${formObject.farmId}&logId=${formObject.logId}&uid=${user.uid}`
